...
class MainWindow(QMainWindow):
    ...
    def createUI(self):
        ...
        self.channel_manager_widget = ChannelManagerWidget(self.channel_registry, self)
        self.tabs.addTab(self.channel_manager_widget, "Channel Manager")
